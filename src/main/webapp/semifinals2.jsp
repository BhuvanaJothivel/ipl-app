...
<html>
	...
	<body>
	<form action="http://localhost:8080/jspservlet-app-ipl/qualifier2" method="post">
		<div>
		...
		<div class="container">
			<h1>QUALIFIER 2</h1>
			<div class="images">
				<img alt="" src="http://localhost:8080/jspservlet-app-ipl/assets/kkr.svg" id="team1">
			...
			<div class="inputs">
				...
				<div id="options">
					<div>
					<input type="radio" name="teamnames"  value="srh"><label>CSK</label>
					</div>
					<div>
					<input type="radio" name="teamnames"  value="csk"><label>SRH</label>
					</div>
			...
			<div class="buttons">
				<button name="team1button" id="teamsrh">VIEW SRH DETAILS</button>
				<button name="team2button" id="teamkkr">VIEW KKR DETAILS</button>
			</div>
			</div>	
	...
	document.getElementById('teamkkr').addEventListener('click',()=>{
		document.getElementById('team-details').style.visibility = "visible";
		document.getElementById('teamplayer-details').style.visibility = "visible";
	})
	</script>
